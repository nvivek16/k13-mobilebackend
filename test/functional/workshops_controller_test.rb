...
class WorkshopsControllerTest < ActionController::TestCase
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post :create, workshop: { description: @workshop.description, name: @workshop.name, place: @workshop.place }
    end
  ...
  test "should update workshop" do
    put :update, id: @workshop, workshop: { description: @workshop.description, name: @workshop.name, place: @workshop.place }
    assert_redirected_to workshop_path(assigns(:workshop))
  end
